...
label = np.loadtxt("/stor/work/SongYi/xp876/ad-data/gen/10000/prediction/label-xiao1.txt")
mat = np.loadtxt("/stor/work/SongYi/xp876/ad-data/gen/10000/prediction/mat-xiao.txt", dtype=np.int8)
print(label.shape)
print(mat.shape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('inn', help='input file')
    parser.add_argument('out', help='input file')
    parser.add_argument('out2', help='input file')
    ...
    pbounds = {'epochs': (30, 30.99), 'bs': (1, 1.99), 'dropout_rate_1': (0.1, 0.49),'dropout_rate_2': (0.1, 0.49),'dropout_rate_3': (0.1, 0.49),
           'uts_1': (1, 4.99), 'uts_2': (1, 4.99),'uts_3': (1, 4.99),'uts_4': (1, 4.99),
            'acti_1': (1, 3.99),'acti_2': (1, 3.99),'acti_3': (1, 3.99),'acti_4': (1, 3.99),
           'init_mode_1': (1, 2.99), 'init_mode_2': (1, 2.99),'init_mode_3': (1, 2.99),'init_mode_4': (1, 2.99),'init_mode_5': (1, 2.99),
