...
def create_model(dropout_rate_1=0.0,dropout_rate_2=0.0,uts_1=1,uts_2=1,uts_3=1,acti_1=1,
                 acti_2=1,
                 acti_3=1,
                 init_mode_1=1,
                 init_mode_2=1,
    ...
    if 1 <= init_mode_4 <= 2:
        init_mode_4 = 'normal'
    elif 2 < init_mode_4 <= 3:
        init_mode_4 = 'ones'
    elif 3 < init_mode_4 <= 4:
        init_mode_4 = 'uniform'
    ...
    dp_2=Dropout(dropout_rate_2)(ds_2)
    ...
    ds_4= Dense(units=1, kernel_initializer=init_mode_4,kernel_regularizer=regularizers.l1_l2(l1=ll_4, l2=ll_4))(ds_3)

    model = Model(inputs=inputs, outputs=ds_4)


    print("dropout_rate_1----"  + "dropout_rate_2----"  +
          "uts_1----" +"uts_2----" +"uts_3----" +
          "acti_1----" +"acti_2----" +"acti_3----" +
           "init_mode_1----" + "init_mode_2----" + "init_mode_3----" + "init_mode_4----" +
          "ll_1----"+"ll_2----"+"ll_3----"+"ll_4----")

    print(str(dropout_rate_1) + "----"  +str(dropout_rate_2) + "----"  +
          str(uts_1) + "----"  +str(uts_2) + "----"  +str(uts_3) + "----"  +
          str(acti_1) + "----"  +str(acti_2) + "----"  +str(acti_3) + "----"  +
          str(init_mode_1) + "----"  +str(init_mode_2) + "----"  +str(init_mode_3) + "----"  +str(init_mode_4) + "----"  +
          str(ll_1) + "----"  +str(ll_2) + "----"  +str(ll_3) + "----"  +str(ll_4) + "----"   )
...
def fit_with(epochs, bs, dropout_rate_1,dropout_rate_2,uts_1,uts_2,uts_3,acti_1,
             acti_2,acti_3,
             init_mode_1,init_mode_2,init_mode_3,init_mode_4,
             ll_1,ll_2,ll_3,ll_4):
    ...
    for i, (train, test) in enumerate(rkf.split(X_train, Y_train)):
        ...
        model = create_model(dropout_rate_1,dropout_rate_2,uts_1,uts_2,uts_3,acti_1,
             acti_2,acti_3,
             init_mode_1,init_mode_2,init_mode_3,init_mode_4,
             ll_1,ll_2,ll_3,ll_4)
        model.compile(loss='mean_squared_error', optimizer='adam',
    ...
    # model.summary()
        ...
        mc = ModelCheckpoint(str(round(epochs, 4)) + "-"  +str(round(bs, 4)) + "-"  +
          str(round(dropout_rate_1, 4)) + "-"  +str(round(dropout_rate_2, 4)) + "-"  +
          str(round(uts_1, 4)) + "-"  +str(round(uts_2, 4)) + "-"  +str(round(uts_3, 4)) + "-"  +
          str(round(acti_1, 4)) + "-"  +str(round(acti_2, 4)) + "-"  +str(round(acti_3, 4)) + "-"  +
          str(round(init_mode_1, 4)) + "-"  +str(round(init_mode_2, 4)) + "-"  +str(round(init_mode_3, 4)) + "-"  +str(round(init_mode_4, 4)) + "-"  +
          str(round(ll_1, 4)) + "-"  +str(round(ll_2, 4)) + "-"  +str(round(ll_3, 4)) + "-"  +str(round(ll_4, 4)) + "-"+'.h5', monitor='val_loss', mode='auto', verbose=1, save_best_only=True)
...
if __name__ == '__main__':
    ...
    pbounds = {'epochs': (50, 50.99), 'bs': (1, 4.99), 'dropout_rate_1': (0, 0.549),'dropout_rate_2': (0, 0.549),
           'uts_1': (1, 5.99), 'uts_2': (1, 5.99),'uts_3': (1, 5.99),
            'acti_1': (1, 3.99),'acti_2': (1, 3.99),'acti_3': (1, 3.99),
           'init_mode_1': (1, 3.99), 'init_mode_2': (1, 3.99),'init_mode_3': (1, 3.99),'init_mode_4': (1, 3.99),
          'll_1': (1, 3.99),'ll_2': (1, 3.99),'ll_3': (1, 3.99),'ll_4': (1, 3.99),
          }
